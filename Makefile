...
hw1client.h:		ecs251_hw1_all4.json
	jsonrpcstub ecs251_hw1_all4.json --cpp-server=hw1Server --cpp-client=hw1Client

hw1server.h:		ecs251_hw1_all4.json
	jsonrpcstub ecs251_hw1_all4.json --cpp-server=hw1Server --cpp-client=hw1Client
