...
Person::Person()
{
  //    std :: cout << "Is this constructor?" << std :: endl;
}
...
(std::string arg_name, std::string arg_id)
{
  this->name = arg_name;
  this->vsID = arg_id;
  std :: cout << "simple person constructor" << std :: endl;
}
...
(Person& aPerson)
{
  std :: cout << "\nInside Person :: \t" << this->vsID << " ::  " << aPerson.getVsID() << std :: endl;
